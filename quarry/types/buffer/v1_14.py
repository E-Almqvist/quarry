...
class Buffer1_14(Buffer1_13_2):
    ...
    def pack_villager(cls, kind, profession, level):
        ...
        return (
            cls.pack_varint(kind) + cls.pack_varint(profession) + cls.pack_varint(level)
        )
    ...
    def unpack_villager(self):
        ...
        """
        kind = self.registry.decode("minecraft:villager_type", self.unpack_varint())
