...
pack_unpack_vectors = [
    ...
    (
        "iiii",
        b"\x00\x00\x00\x00\x7F\xFF\xFF\xFF" b"\x80\x00\x00\x00\xFF\xFF\xFF\xFF",
    ...
    (
        ...
        (0, 9223372036854775807, -9223372036854775808, -1),
    ),
    ("f", b"\x40\x00\x00\x00", 2),
    ("d", b"\x40\x00\x00\x00\x00\x00\x00\x00", 2),
]

uuid_vector = b"\xcb\x3f\x5c\x3d\x0c\x13\x47\x68" b"\x9b\x3c\x43\x3e\x37\x28\x75\x97"
...
slot_vectors = [
    ...
    (
        ...
        b"\x01" b"\x94\x02" b"\x14" b"\x00",  # Present  # ID  # Count
    ),  # NBT
...
entity_metadata_vectors = [
    (
        ...
        b"\x0b\x0b\x02"
        b"\x0c\x0c\x01" + uuid_vector + b"\x0d\x0d\x0d"
