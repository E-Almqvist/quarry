            ...
            "Level": TagCompound(
                {
                    ...
                    "listTest (compound)": TagList(
                        [
                            TagCompound(
                                {
                                    "name": TagString("Compound tag #0"),
                                    "created-on": TagLong(1264099775885),
                                }
                            ),
                            TagCompound(
                                {
                                    "name": TagString("Compound tag #1"),
                                    "created-on": TagLong(1264099775885),
                                }
                            ),
                        ]
                    ...
                    "nested compound test": TagCompound(
                        {
                            "ham": TagCompound(
                                {"name": TagString("Hampus"), "value": TagFloat(0.75)}
                            ),
                            "egg": TagCompound(
                                {"name": TagString("Eggbert"), "value": TagFloat(0.5)}
                            ),
                        }
                    ),
                }
